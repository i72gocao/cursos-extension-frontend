      ...
      <div className="row">
        ...
        <div className="col-sm-4 offset-md-1 py-4">
          ...
          <ul className="list-unstyled">
            <li>
                <Link to="/auth/signin" className="text-white">Iniciar Sesión</Link>
            </li>
            <li>
                <Link to="/pages/contact-us" className="text-white">Contactar Admin</Link>
            </li>
          </ul>
        </div>
      </div>
  ...
  <div className="navbar navbar-dark bg-dark shadow-sm">
    <div className="container">
      <a href="#" className="navbar-brand d-flex align-items-center">
        ...
        <i class="fas fa-graduation-cap" style={{fontSize:"20px",color:"white"}}></i> &nbsp;
        {/* <i class="fad fa-graduation-cap" style={{fontSize:"50px",color:"white"}}></i> */}
