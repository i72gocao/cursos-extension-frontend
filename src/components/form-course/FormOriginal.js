...
const Form = ({handleSubmit,form,setForm,isCreate,urlImage}) => {
    ...
    const handleImage = async (e) => {
        ...
        try {
            ...
            const imagen = document.getElementById("imagen_portada");
            const file = imagen.files[0];
            console.log("Mirando: ", file);
